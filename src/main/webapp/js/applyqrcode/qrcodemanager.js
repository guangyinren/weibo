...
window.Applyqrcode = {
        ...
        function render(data) {
            ...
            if(list.length > 0){
                for (var i = 0; i < list.length; i++) {
                    ...
                    trHtml += '<td>' + $Utils.handleUndefined(item.invoiceIssueOption) + '</td>';
    ...
    view: function (id) {
        ...
        $("#createTime").text(qrcode.createTime);
        layer.open({
            id:'o1',
            type: 1,
...
function Qrcode(invoiceItemName, taxClassificationCode,taxClassificationName,isEnjoyPolicy, policyType, taxRate, taxRateValue,invoiceIssueOptionJson) {
        ...
        this.invoiceIssueOption = invoiceIssueOptionJson
}
